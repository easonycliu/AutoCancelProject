...
function run_once {
	...
	ln $AUTOCANCEL_HOME/scripts/logs/$START_DATE/${CASE}_${START_TIME}/${4}.csv $AUTOCANCEL_HOME/autocancel_exp/$app_exp/autocancel_lib_log
    ...
    mv $AUTOCANCEL_HOME/autocancel_exp/$app_exp/autocancel_lib_log_strip $AUTOCANCEL_HOME/scripts/logs/$START_DATE/${CASE}_${START_TIME}/${4}.csv
