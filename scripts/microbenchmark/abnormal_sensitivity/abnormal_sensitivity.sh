...
function run_once {
    ...
    DEFAULT_POLICY=$1 PREDICT_PROGRESS=$2 CANCEL_ENABLE=$3 AUTOCANCEL_LOG=$4 ABNORMAL_PORTION=$7 ABNORMAL_ABSOLUTE=$8 docker compose -f $AUTOCANCEL_HOME/scripts/microbenchmark/abnormal_sensitivity/docker_config.yml down

    DEFAULT_POLICY=$1 PREDICT_PROGRESS=$2 CANCEL_ENABLE=$3 AUTOCANCEL_LOG=$4 ABNORMAL_PORTION=$7 ABNORMAL_ABSOLUTE=$8 docker compose -f $AUTOCANCEL_HOME/scripts/microbenchmark/abnormal_sensitivity/docker_config.yml up &
    sleep 60
